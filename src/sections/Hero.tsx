    ...
    <section id="hero" className="pt-40 pb-24 md:pt-56 md:pb-40 container mx-auto px-6">
      <div className="max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-brand-muted max-w-2xl font-light leading-relaxed">
          I'm a full-stack developer and data scientist focused on creating elegant, high-performance digital experiences that solve complex problems.
        </p>
        <div className="mt-12 flex flex-wrap gap-4">
          <a href="#software-projects" className="px-8 py-4 bg-brand-dark text-white font-semibold rounded-sm hover:-translate-y-0.5 transition-all duration-300">View My Work</a>
