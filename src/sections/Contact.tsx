    ...
    return (
        <section id="contact" className="py-12 border-t border-gray-200">
            <div className="container mx-auto px-6 text-center">
                <SectionLabel text="05. What's Next?" />
                <h2 className="text-5xl md:text-7xl font-serif font-bold mb-8">Get In Touch</h2>
                ...
                <div className="flex justify-center gap-8">
                    ...
                    <a
                        href="https://www.linkedin.com/in/madison-tana"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="LinkedIn"
                        className="text-brand-dark hover:text-brand-accent transition-colors duration-300"
                    ...
                    <a
                        href="mailto:madisonlilah@gmail.com"
                        aria-label="Email"
                        className="text-brand-dark hover:text-brand-accent transition-colors duration-300"
                    >
